...
class TableViewControllerCategorias: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        opiniones.append(opinion)
        receta = Receta(nombre: "Brownies", dificultad: "Baja", duracion: 50, categoria: "Postres", ingredientes: ingredientes, opiniones: opiniones, precio: 30, nutricion: info, url: "lIb_741_dIw", imagen: #imageLiteral(resourceName: "brownies"), rank: -1, instrucciones: "1.Vertir agua y aceite en un contenedor\n2. Añadir los huevos\n3.Revolver mezcla durante 1 min\n", nacionalidad: nil)
        recetas.append(receta)
